   ...
   <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
           <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
               <div class="space-y-6 sm:px-6 lg:px-0 lg:col-span-12">
                   <form @submit.prevent="updateStudnet">
...
watch(() => formData.class_id, (newValue) => {
       console.log('watch class id ', newValue);
       getSection(newValue);
});
...
const updateStudnet = () => {
   formData.put(route('students.update', student.id));
}

onMounted(() => getSection(student.section.id));
</script>
